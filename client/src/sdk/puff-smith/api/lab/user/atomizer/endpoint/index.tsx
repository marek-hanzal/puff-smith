...
export type IUserAtomizerPageBreadcrumb = BreadcrumbProps | ReactElement<typeof Breadcrumb> | ((entityContext: IEntityContext<import("@/sdk/puff-smith/user/dto/atomizer/index").UserAtomizerDto>) => BreadcrumbProps | ReactElement<typeof Breadcrumb>);
