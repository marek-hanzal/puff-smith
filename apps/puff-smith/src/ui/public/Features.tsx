...
export const Features: FC<IFeaturesProps> = ({translation}) => {
    const {t} = useTranslation();
    return <section className="bg-gray-100 dark:bg-gray-800">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div className="max-w-screen-md mb-8 lg:mb-16">
                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">{t(`${translation}.title`, {value: "aaa"})}</h2>
                <p className="text-gray-500 sm:text-xl dark:text-gray-400">{t(`${translation}.subtitle`)}</p>
            </div>
