...
export interface IVendorInfiniteListSourceProps extends Partial<IInfiniteListProps<ISourceItem<ICottonVendorSource>>> {
	providerProps?: Partial<IVendorProviderProps>;
}
...
export const VendorInfiniteListSource: FC<IVendorInfiniteListSourceProps> = ({providerProps, ...props}) => {
	return <VendorProvider
		...
		{...providerProps}
	>
		<InfiniteList<ISourceItem<ICottonVendorSource>>
			{...props}
		/>
	</VendorProvider>;
}
