...
export interface IAromasSelectionProviderProps extends Partial<ISelectionProviderProps<IAroma>> {
}

export const AromasSelectionProvider: FC<IAromasSelectionProviderProps> = props => {
