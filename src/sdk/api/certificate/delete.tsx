...
export const DeleteApiLink = "/api/certificate/delete";

export type IDeleteQueryParams = any;

export const useDeleteMutation = createMutationHook<string[], ISourceItem<ICertificateSource>>(DeleteApiLink, "post");
...
export const useDeletePromise = createPromiseHook<string[], ISourceItem<ICertificateSource>>(DeleteApiLink, "post");

export const DeletePromise = createPromise<string[], ISourceItem<ICertificateSource>>(DeleteApiLink, "post");
