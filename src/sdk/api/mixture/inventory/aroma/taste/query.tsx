...
export const AromaTasteApiLink = "/api/mixture/inventory/aroma/taste/query";
export const AromaTasteCountApiLink = "/api/mixture/inventory/aroma/taste/query/count";
