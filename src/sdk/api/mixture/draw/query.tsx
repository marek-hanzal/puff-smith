...
export interface IDrawInfiniteListSourceProps extends Partial<IInfiniteListProps<ISourceItem<IMixtureDrawSource>>> {
	providerProps?: Partial<IDrawProviderProps>;
}
...
export const DrawInfiniteListSource: FC<IDrawInfiniteListSourceProps> = ({providerProps, ...props}) => {
	return <DrawProvider
		...
		{...providerProps}
	>
		<InfiniteList<ISourceItem<IMixtureDrawSource>>
			{...props}
		/>
	</DrawProvider>;
}
