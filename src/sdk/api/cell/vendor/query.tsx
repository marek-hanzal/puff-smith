...
export interface IVendorInfiniteListSourceProps extends Partial<IInfiniteListProps<ISourceItem<ICellVendorSource>>> {
	providerProps?: Partial<IVendorProviderProps>;
}
...
export const VendorInfiniteListSource: FC<IVendorInfiniteListSourceProps> = ({providerProps, ...props}) => {
	return <VendorProvider
		...
		{...providerProps}
	>
		<InfiniteList<ISourceItem<ICellVendorSource>>
			{...props}
		/>
	</VendorProvider>;
}
