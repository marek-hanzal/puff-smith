...
export interface IVendorInfiniteListSourceProps extends Partial<IInfiniteListProps<ISourceItem<IBoosterVendorSource>>> {
	providerProps?: Partial<IVendorProviderProps>;
}
...
export const VendorInfiniteListSource: FC<IVendorInfiniteListSourceProps> = ({providerProps, ...props}) => {
	return <VendorProvider
		...
		{...providerProps}
	>
		<InfiniteList<ISourceItem<IBoosterVendorSource>>
			{...props}
		/>
	</VendorProvider>;
};
