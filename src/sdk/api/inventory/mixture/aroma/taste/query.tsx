...
export const AromaTasteApiLink = "/api/inventory/mixture/aroma/taste/query";
export const AromaTasteCountApiLink = "/api/inventory/mixture/aroma/taste/query/count";
...
export const useAromaTasteQueryInvalidate = () => {
	const queryClient = useQueryClient();
	return () => queryClient.invalidateQueries([AromaTasteApiLink]);
};
