...
export const CottonInventoryProvider: FC<ICottonInventoryProviderProps> = props => {
	return <SourceProvider<ISourceItem<ICottonInventorySource>>
		...
		useCountQuery={useCottonInventoryCountQuery}
		{...props}
	/>;
};
...
export const CottonInventoryProviderControl: FC<ICottonInventoryProviderControlProps> = props => <SourceControlProvider<IQueryFilter<ISourceQuery<ICottonInventorySource>>, IQueryOrderBy<ISourceQuery<ICottonInventorySource>>> name={"CottonInventory"} {...props}/>;
...
export interface ICottonInventoryInfiniteListSourceProps extends Partial<IInfiniteListProps<ISourceItem<ICottonInventorySource>>> {
	providerProps?: Partial<ICottonInventoryProviderProps>;
}

export const CottonInventoryInfiniteListSource: FC<ICottonInventoryInfiniteListSourceProps> = ({providerProps, ...props}) => {
	return <CottonInventoryProvider
		withCount
		{...providerProps}
	>
		<InfiniteList<ISourceItem<ICottonInventorySource>>
			{...props}
		/>
	</CottonInventoryProvider>;
}
...
export const useCottonInventoryCountQueryInvalidate = () => {
	const queryClient = useQueryClient();
	return () => queryClient.invalidateQueries([CottonInventoryCountApiLink]);
};

export const useCottonInventoryQueryInvalidate = (withCount: boolean = true) => {
	const queryClient = useQueryClient();
	return () => Promise.all([
		queryClient.invalidateQueries([CottonInventoryApiLink]),
		withCount && queryClient.invalidateQueries([CottonInventoryCountApiLink]),
	]);
};
