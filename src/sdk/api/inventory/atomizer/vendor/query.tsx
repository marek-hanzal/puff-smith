...
export interface IVendorInfiniteListSourceProps extends Partial<IInfiniteListProps<ISourceItem<IAtomizerVendorSource>>> {
	providerProps?: Partial<IVendorProviderProps>;
}
...
export const VendorInfiniteListSource: FC<IVendorInfiniteListSourceProps> = ({providerProps, ...props}) => {
	return <VendorProvider
		...
		{...providerProps}
	>
		<InfiniteList<ISourceItem<IAtomizerVendorSource>>
			{...props}
		/>
	</VendorProvider>;
};
