...
export const DeleteApiLink = "/api/lab/build/delete";

export type IDeleteQueryParams = any;

export const useDeleteMutation = createMutationHook<string[], ISourceItem<IBuildSource>>(DeleteApiLink, "post");
...
export const useDeletePromise = createPromiseHook<string[], ISourceItem<IBuildSource>>(DeleteApiLink, "post");

export const DeletePromise = createPromise<string[], ISourceItem<IBuildSource>>(DeleteApiLink, "post");
