...
export const DeleteApiLink = "/api/comment/delete";

export type IDeleteQueryParams = any;

export const useDeleteMutation = createMutationHook<string[], ISourceItem<ICommentSource>>(DeleteApiLink, "post");
...
export const useDeletePromise = createPromiseHook<string[], ISourceItem<ICommentSource>>(DeleteApiLink, "post");

export const DeletePromise = createPromise<string[], ISourceItem<ICommentSource>>(DeleteApiLink, "post");
