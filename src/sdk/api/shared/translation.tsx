...
export const useTranslationsQuery = createGetQuery<ITranslationsQueryParams, ITranslation[]>(TranslationsApiLink);
...
export const useTranslationsPromise = (query: ITranslationsQueryParams, config?: AxiosRequestConfig) => {
	return useGetPromise<ITranslationsQueryParams, ITranslation[]>(TranslationsApiLink, query, config);
}
