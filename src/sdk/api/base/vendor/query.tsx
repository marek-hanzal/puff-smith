...
export const VendorCountApiLink = "/api/base/vendor/query/count";
...
export interface IVendorInfiniteListSourceProps extends Partial<IInfiniteListProps<ISourceItem<IBaseVendorSource>>> {
	providerProps?: Partial<IVendorProviderProps>;
}
...
export const VendorInfiniteListSource: FC<IVendorInfiniteListSourceProps> = ({providerProps, ...props}) => {
	return <VendorProvider
		...
		{...providerProps}
	>
		<InfiniteList<ISourceItem<IBaseVendorSource>>
			{...props}
		/>
	</VendorProvider>;
};
