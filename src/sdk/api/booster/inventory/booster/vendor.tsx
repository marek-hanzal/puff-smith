...
export const VendorApiLink = "/api/booster/inventory/booster/vendor";

export type IVendorQueryParams = undefined;

export const useVendorQuery = createQueryHook<IQuery, IVendor[], IVendorQueryParams>(VendorApiLink, "post");
