...
export const NicotineApiLink = "/api/booster/inventory/booster/nicotine/query";
export const NicotineCountApiLink = "/api/booster/inventory/booster/nicotine/query/count";
