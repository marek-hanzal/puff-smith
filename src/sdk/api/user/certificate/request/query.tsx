...
export const UserCertificateRequestProviderControl: FC<IUserCertificateRequestProviderControlProps> = props => <SourceControlProvider<IQueryFilter<ISourceQuery<IUserCertificateRequestSource>>, IQueryOrderBy<ISourceQuery<IUserCertificateRequestSource>>> name={"UserCertificateRequest"} {...props}/>;
