...
export default QueryEndpoint<"BaseInventory", IBaseInventoryQuery, IBaseInventory>(async params => BaseInventoryRepository(ofRequest(params)).handleQuery(params));
