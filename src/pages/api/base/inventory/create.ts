...
export default MutationEndpoint<"Create", IBaseInventoryCreate, IBaseInventory>(async params => handlePuffiesException(params, async () => BaseInventoryRepository(ofRequest(params)).handleCreate(params)));
