...
export default QueryEndpoint<"MixtureMarket", IMixtureMarketQuery, IMixtureMarket>(async params => MixtureMarketRepository(ofRequest(params)).handleQuery(params));
