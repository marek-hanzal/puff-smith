...
export default MutationEndpoint<"Create", IModInventoryCreate, IModInventory>(async params => handlePuffiesException(params, async () => ModInventoryRepository(ofParams(params)).handleCreate(params)));
