...
export default MutationEndpoint<"Create", ICellInventoryCreate, ICellInventory>(async params => handlePuffiesException(params, async () => CellInventoryRepository(ofParams(params)).handleCreate(params)));
