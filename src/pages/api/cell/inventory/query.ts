...
export default QueryEndpoint<"CellInventory", ICellInventoryQuery, ICellInventory>(async params => CellInventoryRepository(ofRequest(params)).handleQuery(params));
