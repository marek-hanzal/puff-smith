import {IImportJob, IImportJobParams, IMPORT_JOB} from "@/puff-smith/cli/jobs/import/interface";
...
import {MutationEndpoint, toImport} from "@leight-core/server";
...
export default MutationEndpoint<"Import", IImportJobParams, IImportJob>(async params => JobService(ServiceCreate(params.toUserId())).async<IImportJobParams>(IMPORT_JOB, params, async ({logger, job, jobProgress}) => {
