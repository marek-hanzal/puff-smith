...
export default QueryEndpoint<"BoosterMarket", IBoosterMarketQuery, IBoosterMarket>(async ({request, toUserId}) => BoosterMarketService(defaults(toUserId())).query(request));
