...
export default QueryEndpoint<"BoosterInventory", IBoosterInventoryQuery, IBoosterInventory>(async params => BoosterInventoryRepository(ofParams(params)).handleQuery(params));
