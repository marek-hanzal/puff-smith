...
export default QueryEndpoint<"BoosterInventory", IBoosterInventoryQuery, IBoosterInventory>(async ({request, toUserId}) => BoosterInventoryService(defaults(toUserId())).handleQuery({request}));
