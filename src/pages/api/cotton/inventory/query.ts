...
export default QueryEndpoint<"CottonInventory", ICottonInventoryQuery, ICottonInventory>(async ({request, toUserId}) => CottonInventoryService(ServiceCreate(toUserId())).handleQuery({request}));
