...
export default MutationEndpoint<"Create", ICottonInventoryCreate, ICottonInventory>(async params => handlePuffiesException(params, async () => CottonInventoryRepository(ofParams(params)).handleCreate(params)),);
