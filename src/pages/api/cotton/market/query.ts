...
export default QueryEndpoint<"CottonMarket", ICottonMarketQuery, ICottonMarket>(async ({request, toUserId}) => CottonMarketService(ServiceCreate(toUserId())).query(request));
