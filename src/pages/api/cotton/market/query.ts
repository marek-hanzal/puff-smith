...
export default QueryEndpoint<"CottonsMarket", ICottonMarketQuery, ICottonMarket>(async ({request, toUserId}) => CottonMarketService(ServiceCreate(toUserId())).query(request));
