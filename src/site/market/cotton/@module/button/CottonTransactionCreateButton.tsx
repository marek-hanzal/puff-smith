...
import {useCreateMutation} from "@/sdk/api/cotton/transaction/create";

export interface ICottonTransactionCreateButtonProps extends Partial<ButtonProps> {
	cotton: ICotton;
}

export const CottonTransactionCreateButton: FC<ICottonTransactionCreateButtonProps> = ({cotton, ...props}) => {
