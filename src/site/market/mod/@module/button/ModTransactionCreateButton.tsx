...
import {useCreateMutation} from "@/sdk/api/mod/transaction/create";

export interface IModTransactionCreateButtonProps extends Partial<ButtonProps> {
	mod: IMod;
}

export const ModTransactionCreateButton: FC<IModTransactionCreateButtonProps> = ({mod, ...props}) => {
