...
import {useCreateMutation} from "@/sdk/api/atomizer/transaction/create";

export interface IAtomizerTransactionCreateButtonProps extends Partial<ButtonProps> {
	atomizer: IAtomizer;
}

export const AtomizerTransactionCreateButton: FC<IAtomizerTransactionCreateButtonProps> = ({atomizer, ...props}) => {
