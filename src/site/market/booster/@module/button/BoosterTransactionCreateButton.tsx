...
import {useCreateMutation} from "@/sdk/api/booster/transaction/create";

export interface IBoosterTransactionCreateButtonProps extends Partial<ButtonProps> {
	booster: IBooster;
}

export const BoosterTransactionCreateButton: FC<IBoosterTransactionCreateButtonProps> = ({booster, ...props}) => {
