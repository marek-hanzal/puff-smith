...
type ILiquidSourceEntityInternal = ILiquidEntity<IWithTransaction & IWithMixture<IWithMixtureDraw & IWithNullBase<IWithVendor> & IWithNullBooster<IWithVendor> & IWithAromaSourceEntity>>;
