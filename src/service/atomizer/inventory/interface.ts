...
export interface IAtomizerInventorySource extends ISource<IAtomizerInventoryCreate, IAtomizerInventoryEntity<IWithAtomizerSourceEntity & IWithNullTransaction>, IAtomizerInventory, IAtomizerInventoryQuery> {
}
